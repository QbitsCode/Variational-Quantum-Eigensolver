...
from VQE_utils import build_Ham, build_UCCops, findpostrot, build_FSop, build_HF, UCC_gate, init_gate, ent_gate, postrot_gate
from myutils import getStrFinalRes


class VQE_fs_test(ABC):
    ...
    def measure_energy(self, angles):
        eval_energies = []
        self.term_dict = {}
        for POps in self.Hcommute_groups:                                       # Index to span all excitations of commute_groups
            ...
            eval_energies.append(self.expval(n_distrib, POps, self.HpostRots_dict, self.qHam_dict))
